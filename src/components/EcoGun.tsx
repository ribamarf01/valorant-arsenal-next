...
const EcoGun: FC<GunProps> = ({ uuid, name, className }) => {
  ...
  return (<>
    <Link href={`/${uuid}`}>
      <div className={`flex flex-col items-center h-36 w-72 bg-gray-200 bg-opacity-25 hover:cursor-pointer group ${className ? className : ''}`}>
